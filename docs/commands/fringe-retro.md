# `fringe-retro` — Command Reference

The player-facing save-file tool, and the primary binary: inspect, edit, back up, and manage
save files, with both a command-line interface and an interactive terminal UI.

> Part of the [Fringe Retro Kit command reference](../../COMMANDS.md). See also the map browser
> ([`fringe-retro-map`](fringe-retro-map.md)) and the reverse-engineering workbench
...
templates](../templates.md) defined for that game, with a preview of the fields each one
...
See [docs/formats/ultima4.md](../formats/ultima4.md) for the byte-level layout.
...
See [docs/formats/ultima5.md](../formats/ultima5.md) for the byte-level layout.
...
See [docs/formats/ultima6.md](../formats/ultima6.md) for the byte-level layout.
...
See [docs/formats/wasteland.md](../formats/wasteland.md) for the byte-level layout and the
full skill-id table.
...
templates interactively with `t` in the editor. See [docs/templates.md](../templates.md)
